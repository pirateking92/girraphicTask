...
const AthleteList: React.FC<AthleteListProps> = ({ athletes, racename }) => {
  return (
    <div className="w-full p-6">
      <h2 className="text-2xl font-serif text-center mb-4 bg-stone-200 rounded-md">
        {racename}
      </h2>
      <table className="min-w-full divide-y divide-gray-300 border border-yellow-500 rounded-md">
